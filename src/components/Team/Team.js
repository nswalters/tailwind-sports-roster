        ...
        <div className="mx-auto py-8 px-4 max-w-screen-xl sm:px-6 lg:px-8 lg:py-10">
          <div className="space-y-12">
            <div className="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none text-center mx-auto">
              ...
              <img className="h-48 w-48 mx-auto"src="https://www-league.nhlstatic.com/nhl.com/builds/site-core/b1904568bcb2fbac5e1943f4bbcc4a888f9cd027_1596505987/images/logos/team/current/team-18-dark.svg" alt="Team Logo"></img>
